...
import com.milos.eazyschool.model.Courses;
import com.milos.eazyschool.model.EazyClass;
import com.milos.eazyschool.model.Person;
import com.milos.eazyschool.repository.CoursesRepository;
import com.milos.eazyschool.repository.EazyClassRepository;
...
public class AdminController {
    ...
    public ModelAndView displayStudents(Model model, @RequestParam int id, HttpSession session,
    ...
    public ModelAndView addStudentsToCourse(Model model, @ModelAttribute("person") Person person, HttpSession session) {
        ModelAndView modelAndView = new ModelAndView();
        Courses course = (Courses) session.getAttribute("courses");
        Person foundPerson = personRepository.readByEmail(person.getEmail());
        if (foundPerson == null || !(foundPerson.getPersonId() > 0)) {
